...
def main(argv: list[str] | None = None) -> int:
    ...
    from pa_agent.execution.database_fence import GuiDatabaseWriterProcessLock

    with GuiDatabaseWriterProcessLock():
        # Early diagnostics before Qt / heavy imports: crash dumps + file logging.
        from pa_agent.util.crash_diagnostics import (
