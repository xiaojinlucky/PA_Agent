...
EXECUTION_CONTROL_DB_PATH: Path = PROJECT_ROOT / "records" / "execution_control.sqlite3"
EXECUTION_WORKER_LOCK_PATH: Path = PROJECT_ROOT / "records" / "execution_worker.lock"
