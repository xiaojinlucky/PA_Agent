...
- [ ] v0.1.0 阶段 D 候选发布链：主体已由 `4c9d16fe29611a2c35eaa725e2e843d2e745885b`
  ...
  非终态，故该候选已拒绝。当前本地已增加候选 SHA、最终 JUnit 和完整安装合同绑定，
  并在压缩后逐文件复核 ZIP/索引哈希与语义；8 个红色反例、发布定向 63 项和最终
  非 live 2245 项均通过、0 失败，独立复核无 P0/P1/P2。新 SHA 的 CI、候选和下载
  复核，以及阶段 A 私有真相和正式快捷方式桌面矩阵未通过前，禁止创建稳定
  `v0.1.0` tag 或 GitHub Release。
