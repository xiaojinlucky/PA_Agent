...
- [ ] v0.1.0 阶段 D 发布链：主体已由 `4c9d16fe29611a2c35eaa725e2e843d2e745885b`
  ...
  CI 和候选全新安装门均已通过。候选随后因 100% 缩放图名与验证合同不一致而失败；
  当前显式映射三个缩放名，本机 16 张图/元数据和验证器、65 项定向及 2231 项非 live
  均通过。仍须让命名修复对应发布 SHA 通过提交级 CI 与候选 workflow。阶段 A 私有真相和正式快捷方式桌面矩阵未通过前，
